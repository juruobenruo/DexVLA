...
PRETRAIN=${ROOT}/wjj/model_param/multi_head2/${ACTION_HEAD}_results/checkpoint_all/${LLM}_${LLM_MODEL_SIZE}/vanilla_aloha_${LLM}_vla_pt_f_vit/qwen2_vl_3_cameras_all_data_1_23_pretrain_5w_DiT_H_1_23_full_param_stage_1_50/checkpoint-80000 # with substeps DIT
...
TASKNAME=3_cameras_random_folding_1_25

OUTPUT=${ROOT}/wjj/model_param/multi_head2/${ACTION_HEAD}_results/checkpoint_all/${LLM}_${LLM_MODEL_SIZE}/vanilla_aloha_${LLM}_vla_pt_f_vit/${LLM}_${TASKNAME}_combine_constant_pretrain_Non_EMA_DIT_H_full_param_post_training_50_6w
if [ -d "$OUTPUT" ]; then
   echo 'output exists'
else
